...
$files=@('scripts/verify-windows-vm.ps1','scripts/verify-vm-portable.ps1','scripts/acceptance/vm-safety.ps1','scripts/acceptance/common.ps1','scripts/acceptance/worker.ps1','scripts/acceptance/languages.ps1','scripts/acceptance/runtime.ps1','scripts/acceptance/packaged.ps1','scripts/acceptance/desktop-fixture.ps1','scripts/acceptance/startup-dialog.ps1','scripts/acceptance/browser.ps1')
