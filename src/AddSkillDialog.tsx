...
export function AddSkillDialog({deployments,refresh,onClose,bindSkill}: Props) {
  ...
  const inspect=async()=>{setBusy(true);reset();try{
    ...
    const result=await sourceTask.run(parsed.source);
